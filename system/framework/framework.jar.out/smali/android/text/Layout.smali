...
.method static measurePara(Landroid/text/TextPaint;Ljava/lang/CharSequence;II)F
    ...
    .line 1577
    .local v18, "mt":Landroid/text/MeasuredText;
    invoke-static {}, Landroid/text/TextLine;->obtain()Landroid/text/TextLine;
    ...
    .end local v20    # "spanned":Landroid/text/Spanned;
    ...
    invoke-static {v14, v0}, Ljava/lang/Character;->codePointAt([CI)I

    move-result v15

    .line 1613
    .local v15, "emoji":I
    sget v4, Landroid/text/Layout;->MIN_EMOJI:I

    if-lt v15, v4, :cond_3

    sget v4, Landroid/text/Layout;->MAX_EMOJI:I
    :try_end_1
...
.method public getOffsetForHorizontal(IF)I
    ...
    invoke-static/range {v20 .. v21}, Ljava/lang/Character;->codePointAt(Ljava/lang/CharSequence;I)I

    move-result v9

    .line 1072
    .local v9, "emoji":I
    sget v20, Landroid/text/Layout;->MIN_EMOJI:I

    move/from16 v0, v20

    if-lt v9, v0, :cond_0

    sget v20, Landroid/text/Layout;->MAX_EMOJI:I
